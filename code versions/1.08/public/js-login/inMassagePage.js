          ...
          inputSection:
               '<div class="container">'+
                  '<ul class="nav nav-tabs  col-xs-12">'+
                        '<li class="active col-xs-4 tabInMass"><a data-toggle="tab" href="#home">נכנסות</a></li>'+
                        '<li class="col-xs-4 tabInMass" ><a data-toggle="tab" href="#menu1">יוצאות</a></li>'+
                        '<li class="col-xs-4 tabInMass" ><a data-toggle="tab" href="#menu1">שליחה</a></li>'+
                  '</ul>'+
               "</div>"+
